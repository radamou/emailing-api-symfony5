...
class EmailEventDTO
{
     ...
     *
     * @Expose
     * @Type("Emailing\Domain\DTO\EmailEventVariableDTO")
     */
     ...
     *
     * @Expose
     * @Type("ArrayCollection<Emailing\Domain\DTO\EmailEventTemplateDTO>")
     */
     ...
     *
     * @Expose
     * @Type("ArrayCollection<Emailing\Domain\DTO\EmailEventVariableDTO>")
     */
